...
if(_this2.props.menuElement){
var Menu=_this2.props.menuElement;

return(
_react2.default.createElement(_reactNativeDrawer2.default,{
ref:function ref(c){_this2.drawer=c;},
content:
_react2.default.createElement(Menu,_extends({
navigator:navigator,
closeMenu:_this2.closeMenu},
_this2.props.menuProps)),
...
isRequired,
routeLinks:_react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object).isRequired,
menuElement:_react2.default.PropTypes.element,
